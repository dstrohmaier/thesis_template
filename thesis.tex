...
%%
%% Version: v0.2.mode
%% Authors: Jean Martina, Rok Strnisa, Matej Urbas, David Strohmaier
%% Date: 14/01/2023
%%
%% Copyright (c) 2008-2011, Rok Strniša, Jean Martina, Matej Urbas (template)
%% Copyright (c) 2023-, David Strohmaier (adaptation of template and content)
...
% Citations using biblatex/apa style
\usepackage[
backend=biber,
style=apa,
citestyle=apa,
...
% \submissionnotice{For the Sake of Epistemic Progress}
